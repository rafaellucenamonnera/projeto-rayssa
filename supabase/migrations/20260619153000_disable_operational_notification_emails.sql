-- Disable automatic e-mail delivery for operational notifications.
-- Notifications remain available in-app via public.notifications and the in_app delivery record.
